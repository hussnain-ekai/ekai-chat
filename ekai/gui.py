...
from ekai import urls
from ekai.coders import Coder
from ekai.dump import dump  # noqa: F401
from ekai.io import InputOutput
from ekai.main import main as cli_main
from ekai.scrape import Scraper
...
def search(text=None):
    results = []
    for root, _, files in os.walk("ekai"):
        for file in files:
...
class GUI:
    ...
    def do_sidebar(self):
        with st.sidebar:
            ...
            st.warning(
                "This browser version of ekai is experimental. Please share feedback in [GitHub"
                " issues](https://github.com/ekai-AI/ekai/issues)."
            )
    ...
    def do_recommended_actions(self):
        text = "ekai works best when your code is stored in a git repo.  \n"
        ...
        with st.expander("Recommended actions", expanded=True):
            ...
            with st.popover("Update your `.gitignore` file"):
                st.write("It's best to keep ekai's internal files out of your git repo.")
                self.button("Add `.ekai*` to `.gitignore`", key=random.random(), help="?")
    ...
    def do_add_files(self):
        fnames = st.multiselect(
            ...
            help=(
                ...
                " on. ekai will pull in other relevant code to provide context to the LLM."
            ),
        )
...
def gui_main():
    st.set_page_config(
        ...
        menu_items={
            ...
            "Report a bug": "https://github.com/ekai-AI/ekai/issues",
