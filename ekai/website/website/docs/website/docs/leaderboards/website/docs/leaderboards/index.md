...
# ekai LLM Leaderboards

ekai works best with LLMs which are good at *editing* code, not just good at writing
code.
To evaluate an LLM's editing skill, ekai uses benchmarks that
...
While [ekai can connect to almost any LLM](/docs/llms.html),
it works best with models that score well on the benchmarks.


## Polyglot leaderboard

[ekai's polyglot benchmark](https://ekai.chat/2024/12/21/polyglot.html#the-polyglot-benchmark) 
...
### ekai polyglot benchmark results
...
files = [
    'ekai/website/docs/leaderboards/index.md',
    'ekai/website/_data/polyglot_leaderboard.yml',
]
