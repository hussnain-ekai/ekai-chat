...
ekai goes to some effort to prompt the model to use the language that is configured
for your system.
...
You can explicitly set the language that ekai tells the model to use with
`--chat-language <language>`.
But the LLM may not comply.

## Can I share my ekai chat transcript?

Yes, you can now share ekai chat logs in a pretty way.

1. Copy the markdown logs you want to share from `.ekai.chat.history.md` and make a github gist. Or publish the raw markdown logs on the web any way you'd like.

   ```
   https://gist.github.com/ekai-AI/2087ab8b64034a078c0a209440ac8be0
   ```

2. Take the gist URL and append it to:

   ```
   https://ekai.chat/share/?mdurl=
   ```

This will give you a URL like this, which shows the chat history like you'd see in a terminal:

```
https://ekai.chat/share/?mdurl=https://gist.github.com/ekai-AI/2087ab8b64034a078c0a209440ac8be0
```

## Can I edit files myself while ekai is running?

Yes. ekai always reads the latest copy of files from the file
system when you send each message.

While you're waiting for ekai's reply to complete, it's probably unwise to
edit files that you've added to the chat.
Your edits and ekai's edits might conflict.

## What is ekai AI LLC?

ekai AI LLC is the company behind the ekai AI coding tool.
ekai is 
[open source and available on GitHub](https://github.com/ekai-AI/ekai)
under an 
[Apache 2.0 license](https://github.com/ekai-AI/ekai/blob/main/LICENSE.txt).
