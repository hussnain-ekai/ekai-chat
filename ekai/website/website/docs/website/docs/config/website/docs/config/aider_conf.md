...
nav_order: 15
description: How to configure ekai with a yaml config file.
---

# YAML config file

Most of ekai's options can be set in an `.ekai.conf.yml` file.
ekai will look for a this file in these locations:
...
can also
[download from GitHub](https://github.com/ekai-AI/ekai/blob/main/ekai/website/assets/sample.ekai.conf.yml).

<!--[[[cog
from ekai.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("ekai/website/assets/sample.ekai.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .ekai.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .ekai.model.metadata.json
...
#input-history-file: .ekai.input.history

## Specify the chat history file (default: .ekai.chat.history.md)
#chat-history-file: .ekai.chat.history.md
