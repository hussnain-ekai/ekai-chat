...
[ekai's code editing leaderboard](https://ekai.chat/docs/leaderboards/)
...
You can code with all of these models using ekai like this:
...
$ ekai --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ ekai --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ ekai --model openrouter/meta-llama/llama-3.1-405b-instruct
$ ekai --model openrouter/meta-llama/llama-3.1-70b-instruct
$ ekai --model openrouter/meta-llama/llama-3.1-8b-instruct
```

See the
[installation instructions](https://ekai.chat/docs/install.html)
and other
[documentation](https://ekai.chat/docs/usage.html)
for more details.
...
secured #7 on ekai's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on ekai's code editing
benchmark. 
