---
title: o1 tops ekai's new polyglot leaderboard
excerpt: o1 scores the top result on ekai's new multi-language, more challenging coding benchmark.
...
# o1 tops ekai's new polyglot leaderboard
{: .no_toc }
...
new 
[ekai polyglot leaderboard](/docs/leaderboards/), significantly ahead of
other top LLMs.
The new polyglot benchmark uses many popular coding languages
and was designed to be 
*much more challenging* than ekai's original
...
{: .note :}
See the main 
[ekai leaderboard](https://ekai.chat/docs/leaderboards/)
...
Like ekai's original code editing benchmark,
...
ekai's original code editing benchmark was 
...
[ekai polyglot benchmark repo](https://github.com/ekai-AI/polyglot-benchmark)
on GitHub.
