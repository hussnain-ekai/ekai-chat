...
> Figure 1: ekai coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why ekai uses a plain text format for LLMs to specify code edits (below),
...
Previous [ekai benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[ekai "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
ekai's "whole" edit format, where the
...
#### Notes on the ekai leaderboard

*The results presented here are not directly comparable to results
from the main
[ekai LLM leaderboard](https://ekai.chat/docs/leaderboards/).
