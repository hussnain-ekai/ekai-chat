...
from ekai import __version__
from ekai.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    ...
    group.add_argument(
        ...
        help="Specify a file with ekai model settings for unknown models",
    )
    group.add_argument(
        "--model-metadata-file",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".ekai.input.history") if git_root else ".ekai.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".ekai.chat.history.md") if git_root else ".ekai.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .ekai.llm.history)",
    )
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .ekai* to .gitignore (default: True)",
    )
    ...
    group.add_argument(
        ...
        help="Specify the ekai ignore file (default: .aiderignore in git root)",
    )
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute ekai code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute ekai commits in the git committer name (default: True)",
    )
    group.add_argument(
        "--attribute-commit-message-author",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'ekai: ' if ekai authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'ekai: ' (default: False)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new ekai versions on launch",
        default=True,
    )
    group.add_argument(
        "--show-release-notes",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade ekai to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--version",
    ...
    group.add_argument(
        ...
        "--browser",
        action=argparse.BooleanOptionalAction,
        help="Run ekai in your browser (default: False)",
        default=False,
    )
    group.add_argument(
        "--copy-paste",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable automatic copy/paste of chat between ekai and web UI (default: False)",
    )
    group.add_argument(
        "--apply",
        metavar="FILE",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .ekai.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
