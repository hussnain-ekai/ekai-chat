...
from ekai.sendchat import ensure_alternating_roles, sanity_check_messages
from ekai.utils import check_pip_install_extra
...
MODEL_SETTINGS = []
with importlib.resources.open_text("ekai.resources", "model-settings.yml") as f:
...
class ModelInfoManager:
    ...
    def __init__(self):
        self.cache_dir = Path.home() / ".ekai" / "caches"
...
class Model(ModelSettings):
    def __init__(self, model, weak_model=None, editor_model=None, editor_edit_format=None):
        ...
        self.extra_model_settings = next(
            (ms for ms in MODEL_SETTINGS if ms.name == "ekai/extra_params"), None
        )
