...
from ekai import models, prompts, voice
from ekai.editor import pipe_editor
from ekai.format_settings import format_settings
from ekai.help import Help, install_help_extra
from ekai.llm import litellm
from ekai.repo import ANY_GIT_ERROR
from ekai.run_cmd import run_cmd
from ekai.scrape import Scraper, install_playwright
from ekai.utils import is_image_file
...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by ekai"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.aider_commit_hashes:
            self.io.tool_error("The last commit was not made by ekai in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so ekai can edit them or review them in detail"
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use ekai.")

    def cmd_help(self, args):
        "Ask questions about ekai"
        ...
        from ekai.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of ekai was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from ekai.report import report_github_issue
