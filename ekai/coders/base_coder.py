...
from ekai import __version__, models, prompts, urls, utils
from ekai.analytics import Analytics
from ekai.commands import Commands
from ekai.exceptions import LiteLLMExceptions
from ekai.history import ChatSummary
from ekai.io import ConfirmGroup, InputOutput
from ekai.linter import Linter
from ekai.llm import litellm
from ekai.models import RETRY_TIMEOUT
from ekai.repo import ANY_GIT_ERROR, GitRepo
from ekai.repomap import RepoMap
from ekai.run_cmd import run_cmd
from ekai.utils import format_content, format_messages, format_tokens, is_image_file
...
class Coder:
    ...
    def get_announcements(self):
        lines = []
        lines.append(f"ekai v{__version__}")
    ...
    def show_undo_hint(self):
        ...
        if self.commit_before_message[-1] != self.repo.get_head_commit_sha():
            self.io.tool_output("You can use /undo to undo and discard each ekai commit.")
